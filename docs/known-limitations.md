...
## Живого счёта по ходу карты нет

Решение D4 предполагало обновляемое сообщение со счётом на каждую карту.
Сделаны вехи: начало карты (E5) и её конец (E6) в момент победного раунда.
Само обновляемое сообщение не реализовано — это следующий шаг, и он требует
аккуратности с лимитами Telegram на частоту редактирования.
